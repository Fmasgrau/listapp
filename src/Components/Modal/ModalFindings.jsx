                  ...
                  Object.keys(analyticFindings).map((res, i) => {
                    ...
                    return (
                      <tr key={i}>
                        ...
                        <td className="" ><span className="pl-2 pr-2 pt-1 pb-1" style={{ background: `#${Color(analyticFindings[res]["riskrating"], riskAssesment, riskColour).color}`, borderRadius: '5%',
                      color: `${Color(analyticFindings[res]["riskrating"], riskAssesment, riskColour).fontColor}` }}>{analyticFindings[res]["riskrating"]}</span></td>
